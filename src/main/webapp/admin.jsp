...
<body>
	...
	<div class="container-fluid py-4 px-3">
		...
		<div class="container">
			<div class="row px-3 py-3">
				<div class="col-md-4">
					<a href="almost_products.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="Images/products.png" style="max-width: 80px;"
									class="img-fluid">
								<h4 class="card-title mt-3">Sản phẩm sắp hết</h4>
							</div>
						</div>
					</a>
				</div>
					...
					<div class="modal-body">
						...
						<div class="mb-3">
							<label class="form-label"><b>Tên danh mục</b></label> <input
								type="text" name="category_name" placeholder="Tên danh mục"
								class="form-control" required>
						</div>
						<div class="mb-3">
							<label for="formFile" class="form-label"><b>Hình ảnh</b></label>
						...
						<div class="row">
							<div class="col-md-6 mb-2">
								<label class="form-label"><b>Đơn giá</b></label> <input
									type="number" name="price" placeholder="Đơn giá"
									class="form-control" required>
							</div>
							<div class="col-md-6 mb-2">
								<label class="form-label"><b>Chiết khấu</b></label> <input
									type="number" name="discount" onblur="validate()"
									placeholder="Chiết khấu!" class="form-control">
							</div>
						</div>
						<div class="row">
							<div class="col-md-6 mb-2">
								<label class="form-label"><b>Tồn kho</b></label> <input
									type="number" name="quantity" placeholder="Tồn kho"
									class="form-control">
							</div>
							<div class="col-md-6 mb-2">
								<label class="form-label"><b>Loại danh mục</b></label> <select
