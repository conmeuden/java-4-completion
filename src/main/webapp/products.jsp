...
if (searchKey != null) {
	if (!searchKey.isEmpty()) {
		message = "Hiện thị kết quả cho \"" + searchKey + "\"";
	}else{
	...
	message = "Hiện thị kết quả cho \"" + categoryDao.getCategoryName(Integer.parseInt(catId.trim())) + "\"";
} else {
...
if (prodList != null && prodList.size() == 0) {
	...
	message = "Không có mặt hàng nào có sẵn cho \""
					...
					<div class="container text-center">
						...
						<div class="container text-center mb-2 mt-2">
							<button type="button"
								...
								class="btn btn-primary text-white">Xem sản phẩm</button>
						</div>
					</div>
				</div>
			</div>
