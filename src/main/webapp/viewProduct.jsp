		...
		<div class="row border border-3">
			...
			<div class="col-md-6">
				<div class="container-fluid my-5">
					...
					<br>
					<span class="real-price"><%=product.getProductPriceAfterDiscount()%>k</span>&ensp;
					<span class="product-price"><%=product.getProductPrice()%>k</span>&ensp;
					<span class="product-discount">Ưu đãi <%=product.getProductDiscount()%>&#37;</span><br>
					...
					<span class="fs-5"><b>Danh mục: </b></span>
					<span><%=categoryDao.getCategoryName(product.getCategoryId())%></span>
					<form method="post">
				...
				<a href="viewProduct.jsp?pid=<%=p.getProductId()%>"
					...
					<div class="container text-center">
						...
						<div class="container text-center">
							...
							<span class="product-discount">Ưu đãi <%=p.getProductDiscount()%>&#37;</span><br>
						</div>
					</div>
					</a>
				</div>
