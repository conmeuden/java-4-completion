...
public class AddOperationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (operation.trim().equals("addCategory")) {
			...
			if (flag) {
				message = new Message("Danh mục được thêm thành công!!", "success", "alert-success");
			} else {
				message = new Message("Đã xảy ra lỗi, hãy thử lại!!", "error", "alert-danger");
			}
			...
			if (flag) {
				message = new Message("Sản phẩm được thêm thành công!!", "success", "alert-success");
			} else {
				message = new Message("Đã xảy ra lỗi, hãy thử lại!!", "error", "alert-danger");
			}
			session.setAttribute("message", message);
			...
			message = new Message("Danh mục được cập nhật thành công!!", "success", "alert-success");
			session.setAttribute("message", message);
